...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function cargarHistorial() {
        const response = await fetch(`${apiBaseUrl}solicitudes-estructural/${solicitudId}/historial`);
    ...
    document.getElementById('btnCambiarEstado').addEventListener('click', async () => {
        ...
        const response = await fetch(`${apiBaseUrl}solicitudes-estructural/${solicitudId}/estado`, {
            method: 'PUT',
