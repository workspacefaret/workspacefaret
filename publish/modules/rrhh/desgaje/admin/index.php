...
<section class="hero admin-hero">
    ...
    <div class="admin-hero-actions">
        ...
        <button class="admin-btn admin-btn-secondary" id="btnCompararFps">
            <i class="bi bi-arrow-left-right"></i>
            Comparar con información FPS
        </button>
    </div>
</section>
...
<div class="admin-modal-overlay hidden" id="modalComparacionFps">
    <div class="panel admin-panel admin-modal">
        <div class="admin-modal-header">
            <div class="section-title">
                <h2>Comparar con información FPS</h2>
                <p>Busca una NP para contrastar lo informado por el operador contra la producción registrada en FPS.</p>
            </div>
            <button class="admin-icon-btn" id="btnCerrarModalFps" type="button" title="Cerrar">
                <i class="bi bi-x-lg"></i>
            </button>
        </div>

        <div class="admin-modal-search">
            <input type="text" id="inputNpComparacion" placeholder="Número de NP" maxlength="30">
            <button class="admin-btn admin-btn-primary" id="btnBuscarComparacion" type="button">
        ...
        <div class="admin-modal-columns">
            <div class="admin-modal-column">
                <h3>Registro Desgaje</h3>
                <div id="columnaDesgaje" class="admin-empty-box">Ingresa una NP y presiona Buscar.</div>
            </div>
            <div class="admin-modal-column">
                <h3>Producción FPS</h3>
                <div id="columnaFps" class="admin-empty-box">Ingresa una NP y presiona Buscar.</div>
            </div>
        </div>
    </div>
</div>
...
<script src="/assets/js/rrhh/desgaje-comparacion-fps.js"></script>
