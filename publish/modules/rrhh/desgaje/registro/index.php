...
<script id="trabajoRowTemplateManual" type="text/x-template">
    <div class="trabajo-card" data-row data-modo="MANUAL">
        ...
        <div class="form-grid-mobile">
            ...
            <div class="field">
                <label>Cantidad procesada buena</label>
                <input type="number" data-field="cantidadBuena" min="0" required>
            </div>

            <div class="field">
                <label>Cantidad procesada mala</label>
                <input type="number" data-field="cantidadMala" min="0" required>
            </div>
